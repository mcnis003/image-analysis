...
drops <- c("sample")
seed_data_clean=seed_data_clean[,!(names(seed_data_clean) %in% drops)]

seed_data_clean=sqldf("select seed_data_clean.Name, avg(seed_data_clean.red_mean) as red_mean,avg(seed_data_clean.green_mean) as green_mean,avg(seed_data_clean.blue_mean) as blue_mean,avg(seed_data_clean.Length_long_axis) as length_mean,avg(seed_data_clean.Length_short_axis) as width_mean from seed_data_clean group by seed_data_clean.Name")
