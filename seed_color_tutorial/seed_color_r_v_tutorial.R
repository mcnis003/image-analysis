...
#this an example on how this code can be used to gather seed phenotypic information,
#it is used with seed_color_imagej.txt and the 5 photos provided in the same GitHub directory
#just change the working directory below to match the location of the files produced by ImageJ

setwd("put file pathway here")
